...
import com.alura.Literalura.Servicio.ConvertirDatosAutor;
...
import com.alura.Literalura.Servicio.ConvertirDatos;
import com.alura.Literalura.Servicio.ConvertirDatosAutor;
...
public class Principal {
    ...
    private ConvertirDatosAutor conversorAutor = new ConvertirDatosAutor();
    ...
    // Constructor
    public Principal(LibroRepositorio libRepository, AutorRepositorio autRepository) {
    ...
    private void mostrarMenu() {
        var menu = """
                ...
                8- Buscar los 10 libros más descargados
                9- Búsqueda de autores nacidos después de un año específico  
                10- Buscar autores fallecidos antes de un año específico
                0 - Salir
            """;
